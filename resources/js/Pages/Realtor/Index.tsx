                            ...
                            <Box key={listing.id}>
                                <div className="flex flex-col md:flex-row gap-2 md:items-center justify-between">
                                    <div className={opacity}>
                                        {!!listing.sold_at && (
                                            <div className="text-xs font-bold uppercase mb-2 border border-dashed p-1 border-green-300 text-green-500 dark:border-green-600 dark:text-green-600 inline-block rounded-md">
                                                sold
                                            </div>
                                        )}
